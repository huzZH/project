				...
				<div class="pagination" style="margin:0 auto;">
					第  <s:property value="pageBean.page"/>/<s:property value="pageBean.totalPage"/>页
						<s:if test="pageBean.page != 1">
							<a href="${ pageContext.request.contextPath }/productAction_findByCid.action?arId=<s:property value="arId"/>&page=1" class="firstPage">&nbsp;</a>		
							<a href="${ pageContext.request.contextPath }/productAction_findByCid.action?arId=<s:property value="arId"/>&page=<s:property value="pageBean.page-1"/>" class="previousPage">上一页&nbsp;</a>	
						</s:if>	
						<s:iterator var="i" begin="1" end="pageBean.totalPage" step="1">
							...
							<s:else>
								<a  href="${ pageContext.request.contextPath }/productAction_findByCid.action?arId=<s:property value="arId"/>&page=<s:property value="#i"/>"><s:property value="#i"/></a>
							</s:else>
						</s:iterator>
							
						<s:if test="pageBean.page != pageBean.totalPage">
							<a class="nextPage" href="${ pageContext.request.contextPath }/productAction_findByCid.action?arId=<s:property value="arId"/>&page=<s:property value="pageBean.page+1"/>">下一页&nbsp;</a>
							<a class="lastPage" href="${ pageContext.request.contextPath }/productAction_findByCid.action?arId=<s:property value="arId"/>&page=<s:property value="pageBean.totalPage"/>">&nbsp;</a>
						</s:if>
				</div>
				</div>
