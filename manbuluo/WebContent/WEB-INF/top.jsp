...
<div class="header" id="home">	
			...
			<ul class="header-in">
				<s:if test="#session.existAccount == null">
					<li><a target="_blank" href="indexAction_login.action">登录</a></li><span style="color: #ababab;margin-left: -4px;margin-right: -4px;">|</span>
					<li><a target="_blank" href="indexAction_register.action">  注册</a></li><span style="color: #ababab;margin-left: -4px;margin-right: -4px;">|</span>
				</s:if>
			  ...
			  <ul class="megamenu skyblue">
			  	<s:iterator var="anime" value="animeNav">
							...
							<div class="col1">
								<div class="h_nav">
									...
									<ul>
										...
										<li><a target="_blank"  href="productAction_findByANid.action?anId=<s:property value="#animeName.id"/>&page=1"><s:property value="#animeName.name"/></a></li>
					...
					<div class="cart icon1 sub-icon1">
						...
						<li><a href="cartAction_myCart?cid=<s:property value="cartInfos[0].cartId"/>" ><img alt="" src="images/cat.png"> </a>
